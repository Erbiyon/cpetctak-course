...
interface AddDiplomaSubjectProps {
    onSubjectAdded?: () => void
}

export default function AddDiplomaSubject({ onSubjectAdded }: AddDiplomaSubjectProps) {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        กรอกข้อมูลรายวิชาที่ต้องการเพิ่มในหลักสูตร ปวส.
                    </DialogDescription>
                </DialogHeader>
