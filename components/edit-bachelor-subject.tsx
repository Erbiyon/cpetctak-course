...
interface EditBachelorSubjectProps {
    subject?: Subject
    onSubjectUpdated?: () => void
}

export default function EditBachelorSubject({ subject, onSubjectUpdated }: EditBachelorSubjectProps) {
