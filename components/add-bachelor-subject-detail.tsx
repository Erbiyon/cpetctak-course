...
interface AddBachelorSubjectDetailProps {
    subjectId?: number
    onDetailAdded?: () => void
    hasDetail?: boolean
    subjectDetail?: {
...
export default function AddBachelorSubjectDetail({ subjectId, onDetailAdded, hasDetail, subjectDetail }: AddBachelorSubjectDetailProps) {
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true)
        try {
            const url = hasDetail ? `/api/subject-details/${subjectDetail?.id}` : '/api/subject-details'
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {hasDetail
                            ? (isEditMode ? "แก้ไขข้อมูลรายละเอียดของรายวิชาในหลักสูตร" : "ดูข้อมูลรายละเอียดของรายวิชาในหลักสูตร")
                            : "เพิ่มข้อมูลรายละเอียดของรายวิชาในหลักสูตร"
                        }
                    </DialogDescription>
                </DialogHeader>
                <div className="flex flex-col gap-4 my-4">
                    <div className="flex gap-4 items-end">
                        <div className="flex flex-col gap-2 flex-1">
                            <Label htmlFor="theory-hours">ชั่วโมงบรรยาย</Label>
                            <Input
                                type="number"
                                id="theory-hours"
                                placeholder="กรอกชั่วโมงบรรยาย"
                                className="w-full"
